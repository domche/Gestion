<link href="Public_files/css/myheadcss.css" rel="stylesheet">
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo"><span class="profile-ava">
                                <img alt="logo" src="Public_files/img/logo.png">
                            </span></a>
            <!--logo end-->
            ...
            <div class="nav search-row" id="top_menu">
             ...
             <span class="school_name">BIENVENUE SUR LA PLATE-FORME DE GESTION DU MATERIEL</span>

            <div class="top-nav notification-row">            
                <!-- notificatoin dropdown start-->
                <ul class="nav pull-right top-menu">
                       <li>
            <p><i class="fa fa-phone-square"></i>674811982</p>
            </li>  
